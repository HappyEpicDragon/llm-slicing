...
Usage:
    ...
    .pixi/envs/default/bin/python -m src.basic_apis.dt.collect_data
"""
...
def main():
    ...
    parser.add_argument("--model", type=str,
                        default="data/channel_generality/dt/ppo_teacher/best_model/best_model.zip")
    parser.add_argument("--episodes", type=int, default=60)
    parser.add_argument("--epsilon", type=float, default=0.1)
    parser.add_argument("--scenarios", type=int, nargs="+", default=[0, 1, 2, 3, 4])
    parser.add_argument("--output", type=str, default="data/channel_generality/dt/dataset")
...
def collect(cfg, paths_cfg=None, workdir=None):
    """Hydra entry point: called by channel_generality.py → collect_dt_data mode."""
    tc = cfg.collect_dt_data
    ...
    print(f"[collect_dt_data] {len(scenarios)} scenarios × {n_episodes} episodes")
