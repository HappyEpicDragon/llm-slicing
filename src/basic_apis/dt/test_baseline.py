...
Usage:
    ...
    pixi run python -m src.basic_apis.dt.test_baseline --model_path <path>
"""
...
from src.basic_apis.dt.baseline_model import build_dt_baseline
...
def main():
    ...
    parser.add_argument("--meta_path", type=str, default="data/channel_generality/dt_baseline/dataset/metadata.json")
    ...
    parser.add_argument("--save_root", type=str, default="data/channel_generality/dt_baseline/eval_ood")
