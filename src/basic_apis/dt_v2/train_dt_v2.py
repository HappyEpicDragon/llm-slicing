...
Usage:
    ...
    .pixi/envs/default/bin/python -m src.basic_apis.dt_v2.train_dt_v2
"""
...
def train(
    dataset_dir="data/channel_generality/dt_v2/dataset",
    save_dir="data/channel_generality/dt_v2/dt_model",
    epochs=30,
    batch_size=1024,
    lr=1e-4,
    context_len=20,
    ...
    final = os.path.join(save_dir, "final_dt_v2.pth")
    state = model.module.state_dict() if hasattr(model, "module") else model.state_dict()
...
def train_hydra_tiny(cfg, path_manager):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="data/channel_generality/dt_v2/dataset")
    parser.add_argument("--save_dir", type=str, default="data/channel_generality/dt_v2/dt_model")
