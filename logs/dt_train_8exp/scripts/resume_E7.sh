...
echo "[E7 RESUME] from epoch_30, total=60, gpu=2"
pixi run sim train_dt_v2 \
  ...
  train_dt_v2.resume_from=/root/decision_transformer_slicing/data/channel_generality/dt_v2_8exp/dt_model_E7_mlp/epoch_30.pth \
  2>&1 | tee -a /root/decision_transformer_slicing/logs/dt_train_8exp/E7_mlp.log
echo "EXIT:$?"
