...
echo "[E9] dataset=dataset_D-D encoder=mlp gpu=0 epochs=60"
pixi run sim train_dt_v2 \
  ...
  train_dt_v2.save_dir=/root/decision_transformer_slicing/data/channel_generality/dt_v2_8exp/dt_model_E9_mlp \
  ...
  2>&1 | tee /root/decision_transformer_slicing/logs/dt_train_8exp/E9_mlp.log
echo "EXIT:$?"
