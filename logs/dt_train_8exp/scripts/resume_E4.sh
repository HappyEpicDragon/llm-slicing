...
echo "[E4 RESUME] from epoch_30, total=60, gpu=3"
pixi run sim train_dt_v2 \
  ...
  train_dt_v2.save_dir=/root/decision_transformer_slicing/data/channel_generality/dt_v2_8exp/dt_model_E4_slice_attn \
  ...
  train_dt_v2.resume_from=/root/decision_transformer_slicing/data/channel_generality/dt_v2_8exp/dt_model_E4_slice_attn/epoch_30.pth \
  2>&1 | tee -a /root/decision_transformer_slicing/logs/dt_train_8exp/E4_slice_attn.log
echo "EXIT:$?"
